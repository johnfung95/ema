...
class BlossomScene {
  ...
  constructor(config: BlossomSceneConfig) {
    ...
    this.petals = [];
    this.numPetals = config.numPetals || 28;
    this.petalsTypes = config.petalsTypes;
    this.gravity = config.gravity || 0.3;
    this.windMaxSpeed = config.windMaxSpeed || 1;
  ...
  resetPetal(petal: Petal) {
    petal.x = this.width * 2 - Math.random() * this.width * 6.75;
    petal.y = petal.el.offsetHeight * -1;
    petal.z = Math.random() * 300;
