  ...
  return (
    <div className="" key={id}>
      <div className="relative w-full flex justify-center items-center ">
        <Image src={imgPath} quality={100} alt="Ema" className={imgStyle} />
        {link ? (
          <Link
            href={`/ema-content/${id}`}
            className="absolute inset-0 mt-16 flex flex-col justify-center items-center hover:cursor-pointer"
          >
      ...
      <div
        className={`${bottomBarStyle} flex justify-between m-auto text-xs sm:text-sm`}
      >
        <div>
